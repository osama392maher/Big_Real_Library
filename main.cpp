...
// Last Modification Date: 29/10/2022
// Author1 and ID and Group: Osama Maher  ID: 20210060 (a -> g)
// Author2 and ID and Group: Maya Ayman  ID: 20210508 (h, i)
// Author3 and ID and Group: Rawan Younis  ID: 20210524 (j -> p)
/*
 Description: This is a BigReal class.
 As its name implies, it can handle very big float numbers
 and do the following arithmetic operations on them: +, -, =
 and do comparisons using relational operators such as <, >, ==
 */
